...
function calculateRisk() {
    ...
    const economyData = [
        "> ព្រះរាជសារ៖ កំពុងទាញយកទិន្នន័យពីធនាគារកណ្តាលអន្តរភព...",
        "> ស្ថានភាព Cyber-Coin៖ កំពុងឡើងថ្លៃ +១៥% ធៀបនឹងមាសសុទ្ធ...",
        "> ថវិកាយោធា៖ ត្រូវបានបែងចែកទៅកាន់ Mars Droid Army រួចរាល់...",
        "> ការវិភាគ៖ កំណើនសេដ្ឋកិច្ចអាណាចក្រស្ថិតក្នុងកម្រិតមហិមា (Hyper-Growth)...",
        "> ស្ថានភាពបំណុល៖ គ្មាន (អាណាចក្រដទៃជំពាក់យើង ៥០០ លាន Cyber-Coin)...",
        "> ព្រះរាជបញ្ជា៖ បន្តវិនិយោគលើបច្ចេកវិទ្យា Quantum ដើម្បីរក្សាអំណាចហិរញ្ញវត្ថុ!"
    ];
